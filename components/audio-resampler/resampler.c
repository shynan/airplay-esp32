...
// ESP32/Xtensa: pure float to use hardware FPU (MADD.S), avoid software double emulation
static double apply_filter (artsample_t *A, artsample_t *B, int num_taps)
{
    float sum = 0.0f;
...
#elif !defined(_MSC_VER) || defined(__clang__) || defined(__llvm__) || defined(__INTEL_COMPILER) || defined(__INTEL_LLVM_COMPILER)
